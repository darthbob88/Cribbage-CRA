...
## Implementation
TBH I'm probably going to crib heavily from previous work like [jthurst3](https://github.com/jthurst3/cribbage) and [buchowski](https://github.com/buchowski/cribbage), if only for the scoring and design of the gameplay loop.
